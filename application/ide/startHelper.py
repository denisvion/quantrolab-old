...
def startHelper(modulename,filename,classname,associateAttr,associateTypeName,reportName):
	...
	try:
		global helper
		helper=getattr(module,classname)(parent=None,globals=gv)	# instantiate the helper with class name classname with gv as global variables
	...
	if associateType == 'helperGUI' and helperType == 'helper': # force a non GUI helper to be the associate of a GUI helper
