...
class IgorCommunicator:
    ...
    def __init__(self, new=False):
        ...
        try:
            ...
            raise Exception(
                'Unable to load IgorPro ActiveX Object, ensure that IGOR Pro and pythoncom are installed ')
    ...
    def execute(self, command):
        ...
        code_page = 0
        err_code = 0
        result_tuple = self._app.Execute2(
            flag_nolog, code_page, command, err_code)
    ...
    def __call__(self, commands):
        ...
        if type(commands) == type('string'):
            ...
            raise Exception('IgorApp badly called')
