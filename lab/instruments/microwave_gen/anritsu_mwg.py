...
# This is the baseclass for the Anrtisu MWG. Use the instrumentCopy
# function of the Instruments manager to create copies of this instrument
# with different parameters (e.g. GPIB addresses)
...
class Instr(VisaInstrument):
    ...
    def initialize(self, visaAddress="GPIB0::6"):
        self._output = None
        try:
            if DEBUG:
