...
class Panel(FrontPanel):
    ...
    def toggleOutput(self):
        if self.outputStatus == False or self.outputStatus is None:
    ...
    def __init__(self, instrument, parent=None):
        ...
        self.connect(self.toggleOffsetAmpHighLow, SIGNAL(
            "currentIndexChanged(int)"), self.OffsetAmpHighLowToggled)
