...
class Panel(FrontPanel):
    ...
    def generatePulse(self):
        ...
        self.array.setItem(self.array.rowCount() - 1, 0,
                           QTableWidgetItem(str(self.AmplitudeEdit.getValue())))
        self.array.setItem(self.array.rowCount() - 1, 1,
                           QTableWidgetItem(str(self.FrequencyEdit.getValue())))
        self.array.setItem(self.array.rowCount() - 1, 2,
                           QTableWidgetItem(str(self.DurationEdit.getValue())))
        self.array.setItem(self.array.rowCount() - 1, 3,
                           QTableWidgetItem(str(self.PhaseEdit.getValue())))
        self.array.setItem(self.array.rowCount() - 1, 4,
                           QTableWidgetItem(str(self.DelayFromZeroEdit.getValue())))
    ...
    def __init__(self, instrument, parent=None):
        ...
        self.ModifyMWFrequencyEdit = QCheckBox(
            "Allow Modify MW source frequency")
        ...
        self.connect(self.GenerateButton, SIGNAL(
            "clicked()"), self.generatePulse)
        ...
        self.array.setHorizontalHeaderLabels(
            ['amplitude', 'frequency', 'duration', 'phase', 'delay'])
